...
int main(int argc, char *argv[]) {
  if (argc != 3) {
    ...
    fprintf(stderr, "Conversion types: km_to_mi, mi_to_km, c_to_f, f_to_c\n");
    return 1;
  }
